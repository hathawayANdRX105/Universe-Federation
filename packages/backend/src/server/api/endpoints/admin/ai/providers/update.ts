...
export const paramDef = {
	...
	properties: {
		...
		models: { type: 'array', maxItems: 100, items: { type: 'string', maxLength: 512 } },
		defaultModel: { type: 'string', nullable: true, maxLength: 512 },
		allowedModels: { type: 'array', maxItems: 100, items: { type: 'string', maxLength: 512 } },
