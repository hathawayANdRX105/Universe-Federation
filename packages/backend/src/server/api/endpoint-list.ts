...
export * as 'admin/ai/providers/create' from './endpoints/admin/ai/providers/create.js';
export * as 'admin/ai/providers/delete' from './endpoints/admin/ai/providers/delete.js';
export * as 'admin/ai/providers/fetch-models' from './endpoints/admin/ai/providers/fetch-models.js';
export * as 'admin/ai/providers/list' from './endpoints/admin/ai/providers/list.js';
export * as 'admin/ai/providers/test' from './endpoints/admin/ai/providers/test.js';
export * as 'admin/ai/providers/update' from './endpoints/admin/ai/providers/update.js';
export * as 'admin/ai/settings/show' from './endpoints/admin/ai/settings/show.js';
export * as 'admin/ai/settings/update' from './endpoints/admin/ai/settings/update.js';
...
export * as 'admin/api/access-requests/approve' from './endpoints/admin/api/access-requests/approve.js';
export * as 'admin/api/access-requests/list' from './endpoints/admin/api/access-requests/list.js';
export * as 'admin/api/access-requests/reject' from './endpoints/admin/api/access-requests/reject.js';
...
export * as 'admin/api/apps/unsuspend' from './endpoints/admin/api/apps/unsuspend.js';
export * as 'admin/api/apps/update' from './endpoints/admin/api/apps/update.js';
export * as 'admin/api/settings/show' from './endpoints/admin/api/settings/show.js';
...
export * as 'admin/fingerprint-clusters' from './endpoints/admin/fingerprint-clusters.js';
export * as 'admin/notes/list' from './endpoints/admin/notes/list.js';
export * as 'admin/notes/delete-bulk' from './endpoints/admin/notes/delete-bulk.js';
export * as 'admin/notes/archived-list' from './endpoints/admin/notes/archived-list.js';
export * as 'admin/notes/restore' from './endpoints/admin/notes/restore.js';
export * as 'admin/notes/archive-purge' from './endpoints/admin/notes/archive-purge.js';
export * as 'admin/notes/related-accounts' from './endpoints/admin/notes/related-accounts.js';
export * as 'admin/notes/emergency-ban' from './endpoints/admin/notes/emergency-ban.js';
export * as 'admin/notes/remote/delete-by-host' from './endpoints/admin/notes/remote/delete-by-host.js';
...
export * as 'admin/search-trends/hide' from './endpoints/admin/search-trends/hide.js';
...
export * as 'admin/url-preview/proxy/test' from './endpoints/admin/url-preview/proxy/test.js';
export * as 'ai/chat' from './endpoints/ai/chat.js';
export * as 'ai/conversations/create' from './endpoints/ai/conversations/create.js';
export * as 'ai/conversations/delete' from './endpoints/ai/conversations/delete.js';
export * as 'ai/conversations/list' from './endpoints/ai/conversations/list.js';
...
export * as 'api/access/request' from './endpoints/api/access/request.js';
export * as 'api/access/status' from './endpoints/api/access/status.js';
export * as 'api/apps/create' from './endpoints/api/apps/create.js';
export * as 'api/apps/delete' from './endpoints/api/apps/delete.js';
export * as 'api/apps/list' from './endpoints/api/apps/list.js';
export * as 'api/apps/rotate-secret' from './endpoints/api/apps/rotate-secret.js';
export * as 'api/apps/show' from './endpoints/api/apps/show.js';
export * as 'api/apps/update' from './endpoints/api/apps/update.js';
export * as 'api/tokens/create' from './endpoints/api/tokens/create.js';
export * as 'api/tokens/list' from './endpoints/api/tokens/list.js';
export * as 'api/tokens/revoke' from './endpoints/api/tokens/revoke.js';
...
export * as 'i/update-fingerprint' from './endpoints/i/update-fingerprint.js';
...
export * as 'notes/translate-batch' from './endpoints/notes/translate-batch.js';
...
export * as 'users/note-channels' from './endpoints/users/note-channels.js';
...
export * as 'chat/rooms/bans/delete' from './endpoints/chat/rooms/bans/delete.js';
export * as 'chat/rooms/user-mutes/create' from './endpoints/chat/rooms/user-mutes/create.js';
export * as 'chat/rooms/user-mutes/delete' from './endpoints/chat/rooms/user-mutes/delete.js';
export * as 'chat/rooms/user-mutes/list' from './endpoints/chat/rooms/user-mutes/list.js';
export * as 'chat/rooms/manage/update' from './endpoints/chat/rooms/manage/update.js';
export * as 'chat/rooms/manage/delete-all-messages' from './endpoints/chat/rooms/manage/delete-all-messages.js';
export * as 'chat/rooms/manage/delete-user-messages' from './endpoints/chat/rooms/manage/delete-user-messages.js';
export * as 'chat/rooms/manage/stats' from './endpoints/chat/rooms/manage/stats.js';
