...
export type AdminAiProvidersCreateRequest = operations['admin___ai___providers___create']['requestBody']['content']['application/json'];
export type AdminAiProvidersDeleteRequest = operations['admin___ai___providers___delete']['requestBody']['content']['application/json'];
export type AdminAiProvidersFetchModelsRequest = operations['admin___ai___providers___fetch-models']['requestBody']['content']['application/json'];
export type AdminAiProvidersTestRequest = operations['admin___ai___providers___test']['requestBody']['content']['application/json'];
export type AdminAiProvidersUpdateRequest = operations['admin___ai___providers___update']['requestBody']['content']['application/json'];
export type AdminAiSettingsUpdateRequest = operations['admin___ai___settings___update']['requestBody']['content']['application/json'];
...
export type AdminApiAccessRequestsApproveRequest = operations['admin___api___access-requests___approve']['requestBody']['content']['application/json'];
export type AdminApiAccessRequestsListRequest = operations['admin___api___access-requests___list']['requestBody']['content']['application/json'];
export type AdminApiAccessRequestsRejectRequest = operations['admin___api___access-requests___reject']['requestBody']['content']['application/json'];
export type AdminApiAccessRequestsSuspendRequest = operations['admin___api___access-requests___suspend']['requestBody']['content']['application/json'];
export type AdminApiAppsApproveRequest = operations['admin___api___apps___approve']['requestBody']['content']['application/json'];
export type AdminApiAppsDeleteRequest = operations['admin___api___apps___delete']['requestBody']['content']['application/json'];
export type AdminApiAppsDeleteBulkRequest = operations['admin___api___apps___delete-bulk']['requestBody']['content']['application/json'];
export type AdminApiAppsDeleteBulkResponse = operations['admin___api___apps___delete-bulk']['responses']['200']['content']['application/json'];
export type AdminApiAppsListRequest = operations['admin___api___apps___list']['requestBody']['content']['application/json'];
export type AdminApiAppsRecoverOwnersResponse = operations['admin___api___apps___recover-owners']['responses']['200']['content']['application/json'];
export type AdminApiAppsRejectRequest = operations['admin___api___apps___reject']['requestBody']['content']['application/json'];
export type AdminApiAppsSetOwnerRequest = operations['admin___api___apps___set-owner']['requestBody']['content']['application/json'];
export type AdminApiAppsShowRequest = operations['admin___api___apps___show']['requestBody']['content']['application/json'];
export type AdminApiAppsSuspendRequest = operations['admin___api___apps___suspend']['requestBody']['content']['application/json'];
export type AdminApiAppsUnsuspendRequest = operations['admin___api___apps___unsuspend']['requestBody']['content']['application/json'];
export type AdminApiAppsUpdateRequest = operations['admin___api___apps___update']['requestBody']['content']['application/json'];
export type AdminApiSettingsUpdateRequest = operations['admin___api___settings___update']['requestBody']['content']['application/json'];
export type AdminApiTokensListRequest = operations['admin___api___tokens___list']['requestBody']['content']['application/json'];
export type AdminApiTokensRevokeRequest = operations['admin___api___tokens___revoke']['requestBody']['content']['application/json'];
export type AdminApiTokensRevokeBulkRequest = operations['admin___api___tokens___revoke-bulk']['requestBody']['content']['application/json'];
export type AdminApiTokensRevokeBulkResponse = operations['admin___api___tokens___revoke-bulk']['responses']['200']['content']['application/json'];
export type AdminApiTokensSuspendRequest = operations['admin___api___tokens___suspend']['requestBody']['content']['application/json'];
export type AdminApiTokensUpdateRequest = operations['admin___api___tokens___update']['requestBody']['content']['application/json'];
...
export type AdminChatRoomsListRequest = operations['admin___chat___rooms___list']['requestBody']['content']['application/json'];
export type AdminChatRoomsListResponse = operations['admin___chat___rooms___list']['responses']['200']['content']['application/json'];
export type AdminChatRoomsMessagesRequest = operations['admin___chat___rooms___messages']['requestBody']['content']['application/json'];
export type AdminChatRoomsMessagesResponse = operations['admin___chat___rooms___messages']['responses']['200']['content']['application/json'];
export type AdminChatRoomsShowRequest = operations['admin___chat___rooms___show']['requestBody']['content']['application/json'];
export type AdminChatRoomsShowResponse = operations['admin___chat___rooms___show']['responses']['200']['content']['application/json'];
export type AdminChatRoomsUpdateRequest = operations['admin___chat___rooms___update']['requestBody']['content']['application/json'];
export type AdminChatRoomsUpdateResponse = operations['admin___chat___rooms___update']['responses']['200']['content']['application/json'];
...
export type AdminFingerprintClustersRequest = operations['admin___fingerprint-clusters']['requestBody']['content']['application/json'];
export type AdminFingerprintClustersResponse = operations['admin___fingerprint-clusters']['responses']['200']['content']['application/json'];
...
export type AdminGetUserFingerprintsRequest = operations['admin___get-user-fingerprints']['requestBody']['content']['application/json'];
export type AdminGetUserFingerprintsResponse = operations['admin___get-user-fingerprints']['responses']['200']['content']['application/json'];
...
export type AdminRecommendationBackfillSentimentRequest = operations['admin___recommendation___backfill-sentiment']['requestBody']['content']['application/json'];
export type AdminRecommendationBackfillSentimentResponse = operations['admin___recommendation___backfill-sentiment']['responses']['200']['content']['application/json'];
export type AdminRecommendationGetConfigResponse = operations['admin___recommendation___get-config']['responses']['200']['content']['application/json'];
export type AdminRecommendationPinnedListResponse = operations['admin___recommendation___pinned-list']['responses']['200']['content']['application/json'];
export type AdminRecommendationShowRequest = operations['admin___recommendation___show']['requestBody']['content']['application/json'];
export type AdminRecommendationShowResponse = operations['admin___recommendation___show']['responses']['200']['content']['application/json'];
export type AdminRecommendationUpdateRequest = operations['admin___recommendation___update']['requestBody']['content']['application/json'];
export type AdminRecommendationUpdateResponse = operations['admin___recommendation___update']['responses']['200']['content']['application/json'];
export type AdminRecommendationUpdateConfigRequest = operations['admin___recommendation___update-config']['requestBody']['content']['application/json'];
export type AdminRecommendationUpdateConfigResponse = operations['admin___recommendation___update-config']['responses']['200']['content']['application/json'];
...
export type AdminSearchFingerprintsRequest = operations['admin___search-fingerprints']['requestBody']['content']['application/json'];
export type AdminSearchFingerprintsResponse = operations['admin___search-fingerprints']['responses']['200']['content']['application/json'];
export type AdminSearchTrendsHideRequest = operations['admin___search-trends___hide']['requestBody']['content']['application/json'];
export type AdminSearchTrendsHideResponse = operations['admin___search-trends___hide']['responses']['200']['content']['application/json'];
...
export type AdminUsersSearchRequest = operations['admin___users-search']['requestBody']['content']['application/json'];
export type AdminUsersSearchResponse = operations['admin___users-search']['responses']['200']['content']['application/json'];
export type AiChatRequest = operations['ai___chat']['requestBody']['content']['application/json'];
export type AiConversationsCreateRequest = operations['ai___conversations___create']['requestBody']['content']['application/json'];
export type AiConversationsDeleteRequest = operations['ai___conversations___delete']['requestBody']['content']['application/json'];
export type AiConversationsShowRequest = operations['ai___conversations___show']['requestBody']['content']['application/json'];
export type AiConversationsUpdateRequest = operations['ai___conversations___update']['requestBody']['content']['application/json'];
export type AiMessagesDeleteRequest = operations['ai___messages___delete']['requestBody']['content']['application/json'];
export type AiMessagesListRequest = operations['ai___messages___list']['requestBody']['content']['application/json'];
...
export type ApiAccessRequestRequest = operations['api___access___request']['requestBody']['content']['application/json'];
export type ApiAppsCreateRequest = operations['api___apps___create']['requestBody']['content']['application/json'];
export type ApiAppsDeleteRequest = operations['api___apps___delete']['requestBody']['content']['application/json'];
export type ApiAppsListRequest = operations['api___apps___list']['requestBody']['content']['application/json'];
export type ApiAppsRotateSecretRequest = operations['api___apps___rotate-secret']['requestBody']['content']['application/json'];
export type ApiAppsShowRequest = operations['api___apps___show']['requestBody']['content']['application/json'];
export type ApiAppsUpdateRequest = operations['api___apps___update']['requestBody']['content']['application/json'];
export type ApiTokensCreateRequest = operations['api___tokens___create']['requestBody']['content']['application/json'];
export type ApiTokensCreateResponse = operations['api___tokens___create']['responses']['200']['content']['application/json'];
export type ApiTokensListRequest = operations['api___tokens___list']['requestBody']['content']['application/json'];
export type ApiTokensRevokeRequest = operations['api___tokens___revoke']['requestBody']['content']['application/json'];
...
export type ChannelsByCategoryRequest = operations['channels___by-category']['requestBody']['content']['application/json'];
export type ChannelsByCategoryResponse = operations['channels___by-category']['responses']['200']['content']['application/json'];
export type ChannelsCategoriesResponse = operations['channels___categories']['responses']['200']['content']['application/json'];
...
export type ChatMessagesContextRequest = operations['chat___messages___context']['requestBody']['content']['application/json'];
export type ChatMessagesContextResponse = operations['chat___messages___context']['responses']['200']['content']['application/json'];
...
export type ChatRoomsBansDeleteRequest = operations['chat___rooms___bans___delete']['requestBody']['content']['application/json'];
export type ChatRoomsBansListRequest = operations['chat___rooms___bans___list']['requestBody']['content']['application/json'];
export type ChatRoomsBansListResponse = operations['chat___rooms___bans___list']['responses']['200']['content']['application/json'];
...
export type ChatRoomsKickRequest = operations['chat___rooms___kick']['requestBody']['content']['application/json'];
export type ChatRoomsLeaveRequest = operations['chat___rooms___leave']['requestBody']['content']['application/json'];
export type ChatRoomsManageDeleteAllMessagesRequest = operations['chat___rooms___manage___delete-all-messages']['requestBody']['content']['application/json'];
export type ChatRoomsManageDeleteUserMessagesRequest = operations['chat___rooms___manage___delete-user-messages']['requestBody']['content']['application/json'];
export type ChatRoomsManageDeleteUserMessagesResponse = operations['chat___rooms___manage___delete-user-messages']['responses']['200']['content']['application/json'];
export type ChatRoomsManageStatsRequest = operations['chat___rooms___manage___stats']['requestBody']['content']['application/json'];
export type ChatRoomsManageStatsResponse = operations['chat___rooms___manage___stats']['responses']['200']['content']['application/json'];
export type ChatRoomsManageUpdateRequest = operations['chat___rooms___manage___update']['requestBody']['content']['application/json'];
export type ChatRoomsManageUpdateResponse = operations['chat___rooms___manage___update']['responses']['200']['content']['application/json'];
...
export type ChatRoomsMuteMemberRequest = operations['chat___rooms___mute-member']['requestBody']['content']['application/json'];
...
export type ChatRoomsUnmuteMemberRequest = operations['chat___rooms___unmute-member']['requestBody']['content']['application/json'];
...
export type ChatRoomsUserMutesCreateRequest = operations['chat___rooms___user-mutes___create']['requestBody']['content']['application/json'];
export type ChatRoomsUserMutesCreateResponse = operations['chat___rooms___user-mutes___create']['responses']['200']['content']['application/json'];
export type ChatRoomsUserMutesDeleteRequest = operations['chat___rooms___user-mutes___delete']['requestBody']['content']['application/json'];
export type ChatRoomsUserMutesListRequest = operations['chat___rooms___user-mutes___list']['requestBody']['content']['application/json'];
export type ChatRoomsUserMutesListResponse = operations['chat___rooms___user-mutes___list']['responses']['200']['content']['application/json'];
...
export type IUpdateFingerprintRequest = operations['i___update-fingerprint']['requestBody']['content']['application/json'];
export type IUpdateFingerprintResponse = operations['i___update-fingerprint']['responses']['200']['content']['application/json'];
...
export type NotesDiscoverySectionsRequest = operations['notes___discovery-sections']['requestBody']['content']['application/json'];
export type NotesDiscoverySectionsResponse = operations['notes___discovery-sections']['responses']['200']['content']['application/json'];
...
export type NotesRecommendationFeedbackRequest = operations['notes___recommendation-feedback']['requestBody']['content']['application/json'];
...
export type NotesSearchTrendsRequest = operations['notes___search-trends']['requestBody']['content']['application/json'];
export type NotesSearchTrendsResponse = operations['notes___search-trends']['responses']['200']['content']['application/json'];
