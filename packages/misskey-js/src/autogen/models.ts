...
export type QueueStats = components['schemas']['QueueStats'];
export type QueueLog = components['schemas']['QueueLog'];
export type QueueLogs = components['schemas']['QueueLogs'];
...
export type ChatRoomUserMuting = components['schemas']['ChatRoomUserMuting'];
export type ChatRoomBanning = components['schemas']['ChatRoomBanning'];
